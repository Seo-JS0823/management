...
<body>
	...
	<form action="/manage/noticeUpdate" method="post">
	<input type="hidden" name="manager_id" value="${notice.manager_id}">
	<input type="hidden" name="department_id" value="${notice.department_id}">
	<input type="hidden" name="posting_num" value="${notice.posting_num}">
		...
		<input type="text" id="title" name="title" value="${notice.title}" placeholder="공지 제목 입력" >

		<label for="content">공지 내용</label>
		<textarea id="content" name="content" placeholder="공지 내용을 입력하세요" >${notice.content}</textarea>
